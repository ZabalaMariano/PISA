...
namespace pvb {
    ...
    struct strict_sequence_opt_vb {
        ...
        bitsize(Iterator begin, global_parameters_opt_vb const& params, uint64_t universe, uint64_t n)
        {
            ...
            uint64_t rb_cost = compact_elias_fano_opt_vb::bitsize(sparams, universe, n) + type_bits;
                          ...
                          global_parameters_opt_vb const& params)
        {
            ...
            case ranked_bitvector:
                compact_elias_fano_opt_vb::write(bvb, begin,
                                                universe, n,
                                                sparams);
                break;
            case all_ones:
        ...
        public:
                       ...
                       global_parameters_opt_vb const& params)
            {
                ...
                case elias_fano:
                    ...
                    break;
                case ranked_bitvector:
                    m_rb_enumerator = compact_elias_fano_opt_vb::enumerator(bv, offset + type_bits,
                                                                           universe, n,
                                                                           sparams);
                    break;
                case all_ones:
...
#undef ENUMERATOR_VOID_METHOD
        ...
        private:
            ...
            union {
                ...
                compact_elias_fano_opt_vb::enumerator m_rb_enumerator;
